...
- Paper phase now: validate the finding on AQUA-Bench + a novel mitigation — *pre-generation probing* transferred to Qwen2-Audio ([docs/en/PLAN.md](docs/en/PLAN.md)); plan-minimum guarded by a Jul 24 checkpoint.
