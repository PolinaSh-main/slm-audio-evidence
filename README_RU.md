...
- Сейчас фаза статьи: проверка вывода на AQUA-Bench + новая митигация — перенос *pre-generation пробинга* на Qwen2-Audio ([docs/ru/PLAN.md](docs/ru/PLAN.md)); план-минимум защищён чекпоинтом 24.07.
