...
**This document = execution** (who/when/how). The science (why/what) lives in [PROPOSAL.md](PROPOSAL.md); step-by-step per-member instructions live in [roles/en/](ROLE_M1.md); terms in [GLOSSARY.md](GLOSSARY.md). Русская версия: [PLAN_RU.md](../ru/PLAN.md).
