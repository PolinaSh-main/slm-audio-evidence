...
5. **Decision 3 — checkpoint (Fri Jul 24, ~1 h).** Look at the scale-set table + your own first AUROC. Rule: no working AUROC → switch to plan-minimum (PLAN §5) and announce it. Continuing A2 without numbers is not allowed.
